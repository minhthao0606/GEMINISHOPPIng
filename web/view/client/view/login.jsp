        ...
        <div class="wrapper">
            ...
            <div class="header-v5 header-${url}">
                ...
                <div class="breadcrumbs-v4">
                    <div class="container">
                        <span class="page-name" style="opacity: 0;">Log In</span>
                        <h1>
                            ONLINE SHOPPING FOR MAN
                        </h1>
                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col-md-7 md-margin-bottom-50">
                                <h2 class="welcome-title">Welcome to Online Shopping Website</h2>
                                <p>This is my first website which i have been working with jsp and servlet
                                </p>
                                <br>
                                <div class="info-block-v2">
                                    ...
                                    <div class="info-block-in">
                                        <h3>Fast Delivery</h3>
                                        <p>We collab with leading companies in the field of delivery. Ensure quick and accurate deliveries.</p>
                                    </div>
                                </div>
                                <div class="info-block-v2">
                                    <i class="icon icon-settings"></i>
                                    <div class="info-block-in">
                                        <h3>Awesone Quality</h3>
                                        <p>With products from leading fashion brands in the world. Therefore, all items are extremely high quality</p>
                                    </div>
                                </div>
                                <div class="info-block-v2">
                                    ...
                                    <div class="info-block-in">
                                        ...
                                        <p>We are committed to providing our customers with quality products at extremely affordable prices.</p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-5">
                                ...
                                <div class="row margin-bottom-5">
                                    <div class="col-xs-6">
                                        <label class="checkbox"> <input type="checkbox" name="checkbox" /> <i></i> Remember me
                                        </label>
                                    </div>
