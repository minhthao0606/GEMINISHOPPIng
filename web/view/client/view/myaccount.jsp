...
<body>
	...
	<div class="container bootstrap snippet">
		<div class="row">
			<div class="col-sm-10">
<h3> <a href="${pageContext.request.contextPath}/member/history?uid=${sessionScope.account.id}">  View history</a> </h3>
			</div>
                        
			<div class="col-sm-2">
                            <h3><a href="${pageContext.request.contextPath}/product/list" class="pull-right">Back To Page</a> </h3>
						...
						<div class="form-group">
							...
							<div class="col-xs-6">
								<label for="last_name"><h4>Website</h4></label> <input
									...
									value="geminishopping.com" title="enter your last name if any."
									disabled="disabled">
							</div>
						</div>
