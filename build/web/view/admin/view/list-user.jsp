		...
		<div id="page-wrapper">
			<div id="page-inner">
				<div class="row">
					<div class="col-md-12">
						<h2>List User</h2>
                                                <a href="http://localhost:8080/GEMINISHOPPING/admin/user/add">Add User</a>
										...
										<tbody>
											<c:forEach items="${userList}" var="list">
												...
												<tr class="odd gradeX" >
													...
													<td>${list.password }</td>
                                                                                                        <td class="center"><c:choose>
                                                                                                                <c:when test="${list.active == true}">Active <a href="http://localhost:8080/GEMINISHOPPING/admin/user/active?id=${list.id}">DisActive</a></c:when>
                                                                                                                <c:otherwise>Not Active <a href="http://localhost:8080/GEMINISHOPPING/admin/user/active?id=${list.id}" >Active</a> </c:otherwise>
												...
												<tr class="odd gradeX">
													...
													<td>${list.password }</td>
                                                                                                        <td class="center"><c:choose>
                                                                                                                <c:when test="${list.active == true}">Active</a></c:when>
                                                                                                                <c:otherwise>Not Active </a> </c:otherwise>
