    ...
    <nav class="navbar-default navbar-side" role="navigation">
        <div class="sidebar-collapse">
            <ul class="nav" id="main-menu">
                <li class="text-center"><img src="${url}/img/${sessionScope.account.avatar}"
                                         class="user-image img-responsive" /></li>


            <li><a class="active-menu" href="http://localhost:8080/GEMINISHOPPING/admin"><i
            ...
            <li><a href="http://localhost:8080/GEMINISHOPPING/view/client/view/index.jsp"><i class="fa fa-square-o fa-3x"></i>
                    Web Page</a></li>
        </ul>
