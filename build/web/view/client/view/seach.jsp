					...
					<div class="panel-group" id="accordion-v2">
						<div class="panel panel-default">
							...
							<div id="collapseTwo" class="panel-collapse collapse in">
								<div class="panel-body">
									<ul class="list-unstyled checkbox-list">
										<a href="${pageContext.request.contextPath }/product/category?cate_id=1" >TOP</a>
										<br>
										<a href="${pageContext.request.contextPath }/product/category?cate_id=2">BOTTOM</a>
										<br>
										<a href="${pageContext.request.contextPath }/product/category?cate_id=3" >HAT</a>
                                                                                <br>
                                                                                <a href="${pageContext.request.contextPath }/product/category?cate_id=4" >BAG</a>
										<br>
                                                                                <a href="${pageContext.request.contextPath }/product/category?cate_id=6" >SHOES</a>
                                        				</ul>
								</div>
							</div>
						</div>
							...
							<div id="collapseThree" class="panel-collapse collapse in">
								<div class="panel-body">
									<ul class="list-unstyled checkbox-list">
										...
										<li><label class="checkbox"> <input
												type="checkbox" name="checkbox" /> <i></i> M <small><a
													href="#"></a></small>
										</label></li>
										<li><label class="checkbox"> <input
