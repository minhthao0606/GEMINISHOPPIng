									...
									<div class="btn-group">
										<button type="button" class="btn btn-default dropdown-toggle"
											data-toggle="dropdown">
                                                                                ${requestScope.option} <span class="caret"></span>
										</button>
                         							<ul class="dropdown-menu" role="menu">
											<li><a href="#">All</a></li>
											<li><a href="http://localhost:8080/GEMINISHOPPING/sort?option=cate">Categories</a></li>
                                                                                        <li><a href="http://localhost:8080/GEMINISHOPPING/sort?option=name">A -> Z</a></li>
                                                                                        <li><a href="#">Z -> A</a></li>
											<li><a href="http://localhost:8080/GEMINISHOPPING/sort?option=price">Price Lowest To Highest</a></li>
												...
												<li class="wishlist-in"><i class="fa fa-heart"></i> <a
													...
													${pageContext.request.contextPath }/product/detail?id=${p.id}"">Add
														to Wishlist</a></li>
                                                                                               ...
                                                                                               <li class="wishlist-in"><i class="fa fa-heart"></i> <a
													href="#"> ${p.quantity} items </a></li>                 
												
											</ul>
											<a
												href="${pageContext.request.contextPath }/product/detail?id=${p.id}"><button
													type="button" class="btn-u btn-u-sea-shop">Add to Cart</button></a>
										</div>
