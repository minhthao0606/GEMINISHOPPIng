				...
				<div class="row">
					...
					<div class="col-md-6">
						...
						<ul class="list-inline product-color margin-bottom-30">
							...
							<li><input type="radio" id="color-2" name="color">
						...
						<h3 class="shop-product-title">Quantity : ${product.quantity}</h3>
						...
						<p class="wishlist-category">
							<strong>Categories:</strong> <a href="http://localhost:8080/GEMINISHOPPING/product/category?cate_id=${product.category.id}">${product.category.name}</a>
						</p>
					</div>
				</div>
				<!--/end row-->
